...
**Managed:** {role.managed}""",
    ...
    async def purchase(self, ctx):
        ...
        embed = discord.Embed(
            ...
            description=(
                "Purchase **$6** one time or **$3.50** monthly or **10\n\n"
        ...
        custom_button = Button(label="custom bot - $10", style=discord.ButtonStyle.blurple, url="https://buy.stripe.com/dR6dUJb4s5Cn4ik3co")
