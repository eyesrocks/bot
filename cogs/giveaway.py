from discord import Message, Guild  # type: ignore # type: ignore
...
from rival_tools import thread, ratelimit  # type: ignore
...
class Giveaway(Cog):
    ...
    async def end_giveaway(self, message: Message, winners: int):
        logger.info(f"editting giveaway message to be ended")
