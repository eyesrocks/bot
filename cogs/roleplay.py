...
class MarryView(View):
    ...
    async def yes(self, interaction: Interaction, button: Button):
        ...
        await interaction.response.edit_message(content=None, embed=Embed(description=f"{self.proposee.mention} has accepted {self.proposer.mention}'s proposal!"))
        self.stop()
    ...
    async def no(self, interaction: Interaction, button: Button):
        ...
        await interaction.response.send_message(f"{self.proposee.mention} has rejected {self.proposer.mention}'s proposal!")
        self.stop()
...
class Roleplay(Cog):
    ...
    async def propose(self, ctx: Context, member: Member) -> None:
        ...
        if proposee_res:
            return await ctx.send(f"{member.mention} is already married to someone!")
    ...
    async def spouse(self, ctx: Context) -> None:
        ...
        await ctx.normal(f"{ctx.author.mention} is married to {spouse.mention}!")
    ...
    async def divorce(self, ctx: Context) -> None:
        ...
        await ctx.normal(f"{ctx.author.mention} has divorced {spouse.mention}!")
