...
from discord.ui import Button, ButtonStyle, View, Interaction, button
import aiohttp
...
class MarryView(View):
    ...
    async def yes(self, interaction: Interaction, button: Button):
        ...
        await interaction.response.send_message(f"{self.proposee.mention} has accepted {self.proposer.mention}'s proposal!")
        self.stop()
