...
cache.setup("mem://")
BASE = "tw-answ-"
OBJ_CLASSES = {"input_supplied_source": "sl", "target_language": "tl", "source-text": "source-text", "target_text": "target-text", "target_feminine": "target-text-feminine", "target_masculine": "target-text-masculine", "romanization": "source-romanization", "source_romanization": "source-romanization", "detected_source_language": "detected-sl", "spelling": "spelling", "confident": "spelling-confident", "detected_source_name": "detected-sl-name", "language_detected": "language-detected", "verified": "community-verified"}
...
async def translate(text: str, target_language: str, source_language: Optional[str] = "auto") -> Translation:
