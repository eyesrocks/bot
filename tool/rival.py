...
from tool.important import EmbedBuilder as Builder  # type: ignore  # noqa: F401
from pydantic import BaseModel
from discord import Message
from tool.important.services.YouTube import youtube_post
...
class RivalAPI(object):
    ...
    async def get_youtube_post(self, url: str) -> pos[YouTubePost]:
        data = await youtube_post(url, None)
