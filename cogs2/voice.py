...
class Whisper:
	def __init__(self, model: str = "base"):
		...
		self.model = WhisperModel(self.model_type, device="cpu", compute_type="int8", cpu_threads = 10, num_workers = 3)
	...
	async def execute_whisper(self, filepath: str):
		try:
			return await self.run_with_timeout(self.do_whisper(filepath), timeout=10)  # Set timeout as needed
